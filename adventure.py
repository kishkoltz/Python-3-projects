# E:\python3\app\python.exe adventure.py
...
equipment = {}
gameOn = True
stat = {'might':0,'nimbleness':0,'endurance':0,'commonSense':0,'slyness':0,'charm':0, 'ketosis':0}
finished = False
...
def playerStats():
    ...
    print (("Your ketosis: + " +stat['ketosis']).center(120))
...
What is it?")
        print ("1) Corn flakes and whisky\n2) Fried eggs on bacon (or other keto stuff)\n3) Literally enything else\n")
        choice = input()
        if choice == "m":
            mainMenu()
            break
...
also stands against your dietary regimen.")
            damage(random.randint(0,2))
            stat['ketosis'] = str(int(stat['ketosis'])-1)
            print ("Your ketosis goes down by one point.")
            input()
        if choice == '2':
            print ("\nA sound choice! Yummy, yummy keto dish invigorates you with the energy \
required to go through this special day.")
            life = life + 1
            input()
        if choice == '3':
            print ("\nAh, you couldn't resist the temptation! Your breakfast is tasty, \
but it stands against your dietary regimen.")
            stat['ketosis'] = str(int(stat['ketosis'])-1)
            print ("Your ketosis goes down by one point.")
            input()
        unwrapGift()
...
print (("Your charm: + " +stat['charm']).center(120))
time.sleep(1)
stat['ketosis'] = str(random.randint(0,5))
print (("Your ketosis: + " +stat['ketosis']).center(120))
